...
class SnetClassifier:
    ...
    def __init__(self):
        ...
        self.english_model = '/Users/glauterlemos/Documents/DESENVOLVIMENTO/SINGULARITY_NET/PROJECT/services/nlp-services/named_entity_recognition/services/english.all.3class.distsim.crf.ser.gz'
        self.stanford_jar = '/Users/glauterlemos/Documents/DESENVOLVIMENTO/SINGULARITY_NET/PROJECT/services/nlp-services/named_entity_recognition/services/stanford-ner.jar'
