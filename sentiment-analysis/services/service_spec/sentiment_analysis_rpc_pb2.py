...
# source: services/service_spec/sentiment_analysis_rpc.proto
...
InputMessage = _reflection.GeneratedProtocolMessageType('InputMessage', (_message.Message,), dict(
  ...
  __module__ = 'services.service_spec.sentiment_analysis_rpc_pb2'
