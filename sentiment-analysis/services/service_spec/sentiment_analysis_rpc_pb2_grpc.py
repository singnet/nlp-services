...
from services.service_spec import sentiment_analysis_rpc_pb2 as services_dot_service__spec_dot_sentiment__analysis__rpc__pb2
...
class ShowMessageStub(object):
  ...
  def __init__(self, channel):
    ...
    self.show = channel.unary_unary(
        '/ShowMessage/show',
        request_serializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.InputMessage.SerializeToString,
        response_deserializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.OutputMessage.FromString,
        )
...
def add_ShowMessageServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'show': grpc.unary_unary_rpc_method_handler(
          servicer.show,
          request_deserializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.InputMessage.FromString,
          response_serializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.OutputMessage.SerializeToString,
      ),
  }
...
class SentimentConsensusAnalysisStub(object):
  ...
  def __init__(self, channel):
    ...
    self.consensusAnalysis = channel.unary_unary(
        '/SentimentConsensusAnalysis/consensusAnalysis',
        request_serializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.InputMessage.SerializeToString,
        response_deserializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.OutputMessage.FromString,
        )
...
def add_SentimentConsensusAnalysisServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'SentimentConsensusAnalysis', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
...
class TwitterHistoricalAnalysisStub(object):
  ...
  def __init__(self, channel):
    ...
    self.historicalAnalysis = channel.unary_unary(
        '/TwitterHistoricalAnalysis/historicalAnalysis',
        request_serializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.TwitterInputMessage.SerializeToString,
        response_deserializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.OutputMessage.FromString,
        )
...
def add_TwitterHistoricalAnalysisServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'historicalAnalysis': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.TwitterInputMessage.FromString,
          response_serializer=services_dot_service__spec_dot_sentiment__analysis__rpc__pb2.OutputMessage.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'TwitterHistoricalAnalysis', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
