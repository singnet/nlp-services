...
if __name__ == '__main__':
    ...
    try:
        ...
        logger.debug("call => MarketAnalysis() Method Test Starting... ")
        # TwitterHistoricalAnalysis() Method Test
        # create a stub (client)
        stub = grpc_services.TwitterHistoricalAnalysisStub(channel)
        ...
        # make the call
        response = stub.MarketAnalysis(message)
        logger.debug("call => MarketAnalysis() Method Test Passed => " + response.value)
        print()

    except KeyError as e:
        logger.debug("call => MarketAnalysis() Method Test Error => " + str(e))
