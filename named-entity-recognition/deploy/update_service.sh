...
#Update docker image
docker build -t singularitynet/named_entity_recognition:latest https://raw.githubusercontent.com/singnet/nlp-services/named_entity_recognition/named_entity_recognition/deploy/Dockerfile
